...
Route::get('/', function () {
    return [
        'app' => 'JIMart Powered by Kopkar JIM Supported by Language Center',
        'version' => '1.0.0',
    ];
});
...
Route::prefix('/v1')->group(function () {
    ...
    Route::group(['middleware' => ['jwt', 'jwt.auth']], function () {
        ...
        Route::post('user/deleteUserAccount', [AuthController::class, 'deleteUserAccount']);
    });
    ...
    Route::group(['middleware' => ['store_auth', 'jwt.auth']], function () {
        ...
        Route::post('user/deleteStoreAccount', [AuthController::class, 'deleteStoreAccount']);
    });
    ...
    Route::group(['middleware' => ['driver_auth']], function () {
        ...
        Route::post('user/deleteDriverAccount', [AuthController::class, 'deleteDriverAccount']);
    });
